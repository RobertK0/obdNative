  ...
  /**
    ...
    */
     ...
     */
      ...
      */
     boolean setCurrentDashboard(String dashboardName, int hashKey);
      ...
      */
     String getSettingString(String setting, String def);

     /**
      * Retrieve a setting from the app. NON PUBLIC DO NOT USE SUBJECT TO CHANGE.
      */
     boolean getSettingBoolean(String setting, boolean def);

     /**
      * Retrieve a setting from the app. NON PUBLIC DO NOT USE SUBJECT TO CHANGE.
      */
     long getSettingLong(String setting, long def);

     /**
      * Retrieve a setting from the app. NON PUBLIC DO NOT USE SUBJECT TO CHANGE.
      */
     int getSettingInt(String setting, int def);
      ...
      */
     boolean calibrateAccelerometer();
      ...
      */
     String[] getCurrentThemeUri(String callingPackageName);
     ...
     */
     boolean putThemeData(String packageName, String themeName, String description, String author, String thumbnailUri, in String[] themeFileUris);
     ...
     * This method is asynchronous updates via the adapter
     */
    double[] getPIDValuesAsDouble(in String[] pidsToRetrieve);
     ...
     */
    String[] recombineResponses(in String[] rawResponsesFromECU);
